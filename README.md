...
For access to the vercel env variables, vercel env pull. Since this application is built with Vite, you'll need to preference all .env development variables with VITE_.
